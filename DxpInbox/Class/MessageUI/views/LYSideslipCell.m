...
- (void)layoutSubviews {
    ...
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:_btnContainView.bounds byRoundingCorners:UIRectCornerBottomRight | UIRectCornerTopRight cornerRadii:CGSizeMake(_btnCornerRadius,_btnCornerRadius)];
    CAShapeLayer *maskLayer = [CAShapeLayer layer];
    maskLayer.path = maskPath.CGPath;
    _btnContainView.layer.mask = maskLayer;
